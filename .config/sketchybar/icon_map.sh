...
function icon_map() {
   ...
   "Brave Browser")
        ...
        ;;
   "Calculator" | "Calculette" | "Calcolatrice")
   ...
   "Fusion")
        icon_result=":fusion:"
        ;;
   "System Preferences" | "System Settings" | "系统设置" | "Réglages Système" | "Impostazioni di Sistema")
        icon_result=":gear:"
        ;;
   "GitHub Desktop")
        icon_result=":git_hub:"
   ...
   "Parsec")
        icon_result=":parsec:"
        ;;
   "Preview" | "预览" | "Skim" | "zathura" | "Aperçu" | "Anteprima")
        icon_result=":pdf:"
        ;;
   "PDF Expert")
   ...
   "Reeder")
        icon_result=":reeder5:"
        ;;
   "Reminders" | "提醒事项" | "Rappels" | "Promemoria")
